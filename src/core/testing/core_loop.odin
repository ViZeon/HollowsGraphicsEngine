...
start_functions :: proc() {
    ...
    // prepass writes directly to vault.frame_pixels
    screen_field := prepass_run(g_screen_w, g_screen_h)
    prepass_free(&screen_field)
...
// Stateless — takes DataPoint directly, no global reads
